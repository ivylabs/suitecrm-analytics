...
define([
  ...
  var ExternalEditor = {
    LANG_PATH: "/suitecrmanalytics/api/repos/cte/resources/editor/languages/",
    LOCALE: "en_US",
    PROVIDERS: "/suitecrmanalytics/plugin/cte/api/providers",
    SAVE_FILE_URL: "/suitecrmanalytics/plugin/cte/api/saveFile",
    EXT_EDITOR: "/suitecrmanalytics/plugin/cte/api/edit",
    CAN_EDIT_URL: "/suitecrmanalytics/plugin/cte/api/canEdit",
    CAN_READ_URL: "/suitecrmanalytics/plugin/cte/api/canRead",
    GET_FILE_URL: "/suitecrmanalytics/plugin/cte/api/getFile",
    STATUS: {
      OK: "ok",
      ERROR: "error"
    }
